...
# environments that the Q-learning agent can be trained against -
const _QLearningEnvironment = Union{MyRectangularGridWorldModel, MyExperimentalDrugCocktailContext}
# PRIVATE METHODS ABOVE HERE ================================================================================= #

# PUBLIC METHODS BELOW HERE ================================================================================== #
"""
    solve(agent::MyQLearningAgentModel, environment;
...
- `environment`: the environment model, e.g., a `MyRectangularGridWorldModel` or a `MyExperimentalDrugCocktailContext`.
...
"""
function solve(agent::MyQLearningAgentModel, environment::_QLearningEnvironment;
    maxsteps::Int = 100, δ::Float64 = 0.02, worldmodel::Function = _world)::MyQLearningAgentModel
...
Alias for [`policy`](@ref): compute the greedy policy from a Q-value table.
"""
